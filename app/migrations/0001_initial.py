    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rival', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.Player')),
            ],
        ),
        migrations.CreateModel(
            name='Song',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('editor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.Player')),
                ('recommend', models.ManyToManyField(blank=True, related_name='recommend', to='app.Song')),
        ...
        migrations.AddField(
            model_name='league',
            name='invite',
            field=models.ManyToManyField(blank=True, related_name='invite', to='app.Player'),
        ),
        migrations.AddField(
            model_name='league',
            name='owner',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owner', to='app.Player'),
        ),
        migrations.AddField(
            model_name='league',
            name='player',
        ...
        migrations.AddField(
            model_name='league',
            name='playlist',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Playlist'),
        ),
        migrations.AddField(
            model_name='league',
            name='virtual',
            field=models.ManyToManyField(blank=True, related_name='virtual', to='app.Player'),
        ),
    ]
