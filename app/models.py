...
class League(models.Model):
    ...
    prohibited_leagues = models.ManyToManyField(
        "self", blank=True, symmetrical=True, related_name="prohibited"
    )
...
class Match(models.Model):
    ...
    player1 = models.ForeignKey(
        Player, on_delete=models.SET_NULL, null=True, related_name="player1"
    )
    retry1 = models.BooleanField()
    result1 = models.IntegerField(default=0)
    player2 = models.ForeignKey(
        Player, on_delete=models.SET_NULL, null=True, related_name="player2"
    )
